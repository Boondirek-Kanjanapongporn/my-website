...
export const About = {
  ...
  description:
        "Hi readers, my nickname is Boon, and I am a graduate of \
    the University of Glasgow with a 1st Class Honours degree in Software Engineering and Computer Science. \
    Please feel free to check my Resume and other details below! :)",
  newline: false,
  buttonLabel: "Resume",
  to: {
    pathname:
      "https://drive.google.com/file/d/1nhfgAUE6rK5Xas0dlIk3xT71U2n8ovD5/view?usp=sharing",
  },
  target: "_blank",
  imgStart: false,
  img: aboutmeimg,
